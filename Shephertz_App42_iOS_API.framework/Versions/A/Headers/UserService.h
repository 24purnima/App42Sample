...
//Api for deleteUserProfile
-(void)deleteUserProfile:(NSString *)userName completionBlock:(App42ResponseBlock)completionBlock;

//Api for unsubscribeMediaChannel
-(void)unsubscribeMediaChannel:(NSString *)userName media:(NSString *)media deviceToken:(NSString *)deviceToken completionBlock:(App42ResponseBlock)completionBlock;

-(void)getMarketOptoutFlag:(NSString *)userName completionBlock:(App42ResponseBlock)completionBlock;
-(void)marketingOptout:(NSString *)userName optoutFlag:(BOOL)optoutFlag completionBlock:(App42ResponseBlock)completionBlock;
-(void)deleteMaUserProfile:(NSString *)userName completionBlock:(App42ResponseBlock)completionBlock;
